      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="flex flex-col items-center bg-white p-6 rounded-lg shadow-lg md:w-1/3 w-full">
          <Image
            ...
            width={100}
            height={100}
            className="w-32 h-32 rounded-full object-cover border-4 border-indigo-500 mb-6"
          />
          <h2 className="text-xl font-semibold text-gray-800">Muhammad Shayan Khan</h2>
          <p className="text-indigo-500 mb-6">Software Engineer</p>
        ...
        <div className="md:w-2/3 w-full">
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-800 mb-6 relative inline-block">
            What I Do
            <span className="absolute left-0 bottom-0 h-2 w-20 bg-indigo-400"></span>
          </h1>
          <div className="flex space-x-4 mb-6">
            <a href="images/resume.pdf" download className="px-6 py-2 bg-indigo-600 text-white font-semibold rounded-md hover:bg-indigo-500 transition duration-300">
              Download Resume
            </a>
            <a href="#projects" className="px-6 py-2 bg-gray-800 text-white font-semibold rounded-md hover:bg-gray-700 transition duration-300">
              View Projects
            </a>
          </div>
