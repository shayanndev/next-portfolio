...
export default function Projects() {
    ...
    return (
        <section className="p-8 md:p-16 bg-gray-50" id="projects">
                ...
                {projects.map((project) => (
                    <div key={project.id} className="bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                        ...
                        <div className="p-4">
                            ...
                            <a
                                className="px-6 py-2 bg-indigo-600 text-white font-semibold rounded-md hover:bg-indigo-500 transition duration-300 cursor-pointer"
                            >
                                View Details
                            </a>
                        </div>
